...
export const dictionaries: Dictionary[] = [
  ...
  { id: 'xdf', name: '新东方四级', description: '新东方四级乱序1-10节', category: '自创词典', url: './dicts/xindongfang.json', length: 691 },
  { id: 'xdf', name: '四级闪过', description: '四级词汇闪过', category: '自创词典', url: './dicts/shanguo.json', length: 114 },
